        ...
        <div class="splide__track" id="splide__track">
          <Splide :options="options" >
            ...
            <splide-slide>
              ...
              <img class="layer bleu mousse vue3" src="@/assets/mousse-arriere-bleu.png" alt="vue3 mousse bleu">
              <img class="layer vert mousse vue3" src="@/assets/mousse-arriere-verte.png" alt="vue3 mousse vert"> 
              <img class="layer violet mousse vue3" src="@/assets/mousse-arriere-violette.png" alt="vue3 mousse violet">                
            </splide-slide>
          </Splide>
        </div>
      </div>
