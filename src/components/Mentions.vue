<template>
  <div class="row -center">
    <div class="col-l-8">
      <h2 class="title -small -colorWhite">Définitions</h2>
      <p>
        ...
        <a class="fontLink" href="https://lone.ambregeiss.fr/">https://lone.ambregeiss.fr/</a>
      ...
      <h2 class="title -small -colorWhite">1. Présentation du site internet.</h2>
      <p>
      ...
      <p>
        <strong>Propriétaire</strong> : Clément Villa – 13 Rue Pierre Curie
        70000 NAVENNE<br />

        <strong>Responsable publication</strong> : villa.clement@gmail.com –
        villa.clement@gmail.com<br />
        Le responsable publication est une personne physique ou une personne
        morale.<br />
        <strong>Webmaster</strong> : Clément Villa – villa.clement@gmail.com<br />
        <strong>Hébergeur</strong> : Infomaniak – Rue Eugène-Marziano 25 1227
        Genève, Suisse 00 41 22 820 35 40<br />
        <strong>Délégué à la protection des données</strong> : Pierre Biron –
        contact@ambregeiss.fr<br />
      </p>
      ...
      <div ng-bind-html="linkHTML">
        <p>
          ...
          <a class="fontLink"
            ...
            >générateur gratuit de mentions légales pour un site internet</a
          >
        </p>
      </div>

      <h2 class="title -small -colorWhite">
      ...
      <h2 class="title -small -colorWhite">3. Description des services fournis.</h2>

      <p>
        Le site internet
        <a class="fontLink" href="https://lone.ambregeiss.fr/">https://lone.ambregeiss.fr/</a> a
      ...
      <p>
        ...
        <a class="fontLink" href="https://lone.ambregeiss.fr/">https://lone.ambregeiss.fr/</a> ne
        sont pas exhaustifs. Ils sont donnés sous réserve de modifications ayant
        été apportées depuis leur mise en ligne.
      </p>

      <h2 class="title -small -colorWhite">4. Limitations contractuelles sur les données techniques.</h2>
      ...
      <p>
        <a class="fontLink" href="https://lone.ambregeiss.fr/">https://lone.ambregeiss.fr/</a> et
      ...
      <h2 class="title -small -colorWhite">5. Propriété intellectuelle et contrefaçons.</h2>
      ...
      <h2 class="title -small -colorWhite">6. Limitations de responsabilité.</h2>
      ...
      <p>
        ...
        <a class="fontLink" href="https://lone.ambregeiss.fr/">https://lone.ambregeiss.fr/</a> se
      ...
      <h2 class="title -small -colorWhite">7. Gestion des données personnelles.</h2>
      ...
      <p>
        ...
        responsable du traitement des Données Personnelles est : Clément Villa.
        <a class="fontLink" href="https://lone.ambregeiss.fr/">https://lone.ambregeiss.fr/</a>est
        représenté par Clément Villa, son représentant légal
      </p>
      ...
      Clément Villa – DPO, Pierre Biron <br />
      13 Rue Pierre Curie 70000 NAVENNE.
      ...
      <h2 class="title -small -colorWhite">8. Notification d’incident</h2>
      <p>
      ...
      <h2 class="title -small -colorWhite">9. Liens hypertextes « cookies » et balises (“tags”) internet</h2>
      <p>
        Le site
        <a class="fontLink" href="https://lone.ambregeiss.fr/">https://lone.ambregeiss.fr/</a>
      ...
      <p>
        ...
        être le cas lorsque
        <a class="fontLink" href="https://lone.ambregeiss.fr/">https://lone.ambregeiss.fr/</a> ou
      ...
      <p>
        ...
        <a class="fontLink" href="https://lone.ambregeiss.fr/">https://lone.ambregeiss.fr/</a>. À
      ...
      <p></p>
      <h2 class="title -small -colorWhite">10. Droit applicable et attribution de juridiction.</h2>
      <p>
